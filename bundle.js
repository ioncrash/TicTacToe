...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignOutX = function onSignOutX(e) {
	  e.preventDefault();
	  if (store.player_x) {
	    api.signOutX().then(ui.success).catch(ui.failure);
	  }
	...
	var onSignOutO = function onSignOutO(e) {
	  e.preventDefault();
	  if (store.player_o) {
	    api.signOutO().then(ui.success).catch(ui.failure);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayStartButton = function displayStartButton() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var checkCats = function checkCats() {
	  var board = currentGame.current.game.cells;
	  return !board.some(function (e) {
	    return e === "";
	  });
	};
