...
/***/ function(module, exports, __webpack_require__) {
	...
	var onXChangePassword = function onXChangePassword(e) {
	  var data = getFormFields(this);
	  e.preventDefault();
	  if (store.player_x) {
	    api.changeXPassword(data).then(ui.success).catch(ui.failure);
	  }
	  $('#change-x-password-modal').modal('hide');
	};

	var onOChangePassword = function onOChangePassword(e) {
	  var data = getFormFields(this);
	  e.preventDefault();
	  if (store.player_o) {
	    api.changeOPassword(data).then(ui.success).catch(ui.failure);
	  }
	  $('#change-o-password-modal').modal('hide');
	};

	var onShowXStats = function onShowXStats(e) {
	  e.preventDefault();
	  api.getXStats().then(ui.showXStatsSuccess).catch(ui.failure);
	};

	var onShowOStats = function onShowOStats(e) {
	  e.preventDefault();
	  api.getOStats().then(ui.showOStatsSuccess).catch(ui.failure);
	};

	var onSignOutX = function onSignOutX(e) {
	  e.preventDefault();
	  gameEvents.signOutX();
	  if (store.player_x) {
	    api.signOutX().then(ui.signOutXSuccess).catch(ui.failure);
	  }
	...
	var onSignOutO = function onSignOutO(e) {
	  ...
	  gameEvents.signOutO();
	  if (store.player_o) {
	    api.signOutO().then(ui.signOutOSuccess).catch(ui.failure);
	  }
	...
	module.exports = {
	  onSignUp: onSignUp,
	  onSignIn: onSignIn,
	  onXChangePassword: onXChangePassword,
	  onOChangePassword: onOChangePassword,
	  onSignOutX: onSignOutX,
	  onSignOutO: onSignOutO,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var changeXPassword = function changeXPassword(data) {
	  return $.ajax({
	...
	var changeOPassword = function changeOPassword(data) {
	  return $.ajax({
	...
	var getXStats = function getXStats() {
	  return $.ajax({
	    url: app.host + 'games',
	    method: 'GET',
	    headers: {
	...
	var getOStats = function getOStats() {
	  return $.ajax({
	    url: app.host + 'games',
	    method: 'GET',
	    headers: {
	...
	var signOutX = function signOutX() {
	  return $.ajax({
	...
	var signOutO = function signOutO() {
	  return $.ajax({
	...
	module.exports = {
	  signUp: signUp,
	  signIn: signIn,
	  changeXPassword: changeXPassword,
	  changeOPassword: changeOPassword,
	  getXStats: getXStats,
	  getOStats: getOStats,
	  signOutX: signOutX,
	  signOutO: signOutO
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(6);
	var gameEvents = __webpack_require__(8);
	var currentGame = __webpack_require__(10);
	...
	module.exports = {
	  ...
	  showXStatsSuccess: showXStatsSuccess,
	  showOStatsSuccess: showOStatsSuccess,
	  signOutXSuccess: signOutXSuccess,
	  signOutOSuccess: signOutOSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var checkWin = function checkWin(index) {
	  var solutionSet = check.solutions[index];
	  var board = currentGame.current.game.cells;
	  // check each solution against the board
	  for (var i = 0; i < solutionSet.length; i++) {
	    if (board[solutionSet[i][0]] === board[solutionSet[i][1]] && board[solutionSet[i][0]] === currentGame.turn) {
	      theyWon();
	    }
	  }
	  return false;
	...
	var playerMove = function playerMove(index) {
	  checkWin(index);
	...
	var addBoxHandlers = function addBoxHandlers() {
	...
	var forfeitGame = function forfeitGame() {
	  changePlayer();
	  theyWon();
	};
...
/***/ function(module, exports) {
	...
	var solutions = [[[1, 2], [4, 8], [3, 6]], [[4, 7], [0, 2]], [[0, 1], [4, 6], [5, 8]], [[0, 6], [4, 5]], [[0, 8], [1, 7], [2, 6], [3, 5]], [[2, 8], [3, 4]], [[0, 3], [2, 4], [7, 8]], [[1, 4], [6, 8]], [[0, 4], [2, 5], [6, 7]]];
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["getFormFields"] = __webpack_require__(13);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
